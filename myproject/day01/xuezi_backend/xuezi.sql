...
CREATE TABLE xz_laptop_pic(
    ...
    sm VARCHAR(128),    #Small
    md VARCHAR(128),    #Medium
    lg VARCHAR(128)     #Large
);
...
CREATE TABLE xz_user(
    ...
    email VARCHAR(64),
    phone VARCHAR(16),
    avatar VARCHAR(16),     #头像
    user_name VARCHAR(32),
    gender INT              #性别
);
#创建接收人信息表xz_receiver_address
CREATE TABLE xz_receiver_address(
    ...
    postcode VARCHAR(16),
    tag VARCHAR(16),
    is_default TINYINT      #该地址是否为当前用户的默认地址
);

/*购物车模块相关表*/
#创建购物车表xz_shopping_cart
...
/*其他表*/
#创建首页轮播广告条目表xz_carousel
CREATE TABLE xz_carousel(
    cid INT PRIMARY KEY AUTO_INCREMENT,
    img VARCHAR(128),
    title VARCHAR(64),
    href VARCHAR(128)
);
#创建首页商品条目表xz_index_product
